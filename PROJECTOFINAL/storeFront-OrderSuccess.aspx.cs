...
namespace PROJECTOFINAL
{
    public partial class storeFront_OrderSuccess : System.Web.UI.Page
    {
        ...
        protected void lbtn_emailQR_Click(object sender, EventArgs e)
        {
            ...
            string qrLink = "https://api.qrserver.com/v1/create-qr-code/?data="+ "Q" + Request.QueryString["oID"].ToString() + "_" + Request.QueryString["cID"].ToString() +"-" + Request.QueryString["pID"].ToString();
